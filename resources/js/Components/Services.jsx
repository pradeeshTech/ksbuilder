  ...
  return (
    <div >
      <div className=" relative my-[20px] flex justify-center items-center h-[40px] px-[5%] " >
        <h1 className=" text-[30px] text-[#333333] font-semibold  " >Services</h1>
        {/* <button className="" >Edit</button> */}
      </div>
      <div className="breadcrumb mb-[40px]" onClick={() => { setContentSectionTarget('1 Services'), setSectionId(findObject('1 Services')?.section_content?.[0]?.id) }}>
        <a href="#" className=" font-semibold " >KSK BUILDER</a>
        <span className=" font-semibold " onClick={() => { }} >Services</span>
